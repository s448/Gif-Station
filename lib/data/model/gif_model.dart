class GifsModel {
  ...
  GifsModel({this.data, this.pagination, this.meta});
...
class Images {
  ...
  Images.fromJson(Map<String, dynamic> json) {
    ...
    wwStill = json['ww_still'] != null
        ? new Downsized.fromJson(json['ww_still'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.wwStill != null) {
      data['ww_still'] = this.wwStill!.toJson();
    }
    return data;
  }
}
